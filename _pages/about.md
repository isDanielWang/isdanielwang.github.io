                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding:20px;width:100%;vertical-align:middle">
                            ...
                            <p></p>
                            <strong> The finalist price of Interdisplinary Contest In Modeling</strong> <font color='red'><strong>(Top 1% among candidates worldwide)</strong></font> <a href='../files/icmmcm_certificate.pdf'>Certificate of Achievement</a>
                            <p></p>
                            2021.02  
                            <br>
...
frequency of intra-genre artists.
  ...
  <p>Through iNPD method, market and SET trend analysis, combined with the team's personal life experience, the project identified a mobile shooting platform product opportunity in line with the current trend. The team selected the best product concept from several preliminary designs using a weight matrix and 3d modeled the product concept using Solid Works. The design cleverly uses both sides of the backpack to place the kettle, using the appearance of the cylinder and the design of the clip, to achieve a stable bracket design that can be adapted to most of the bags on the market.</p>
                        </td>
                        </tr>
                        <tr>
                        <td style="padding:20px;width:30%;vertical-align:middle">
                            <img src="../images/2048.png" width="200" height="200">
                        </td>
                        <td style="padding:20px;width:100%;vertical-align:middle">
                    ...
                    <tr>
                        ...
                        <td style="padding:20px;width:100%;vertical-align:middle">
                            ...
                            <p>A deep learning model is designed to solve the film recommendation problem, and good results are achieved on Netflix's dataset.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:20px;width:30%;vertical-align:middle">
